...
namespace Hospital.Configs
{
    ...
    public class ApplicationConfiguration
    {
        ...
        private string _databaseConnection = "Data Source=RALUUU_LPT\\SQLEXPRESS;Initial Catalog=HospitalManagement;Integrated Security=True;TrustServerCertificate=True";
