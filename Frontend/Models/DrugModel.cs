...
namespace Frontend.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DrugModel"/> class with default values.
        /// </summary>
        public DrugModel()
        {
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DrugModel"/> class with specified values.
        /// </summary>
        ...
        public DrugModel(int drugID, string name, string administration, string specification, int supply)
        {
            this.DrugID = drugID;
            this.Name = name;
