...
namespace Backend.Configs
{
    ...
    public class ApplicationConfiguration
    {
        ...
        private string _databaseConnection = "Data Source=DIANA\\SQLEXPRESS;Initial Catalog=HospitalManagement;Integrated Security=True;TrustServerCertificate=True";
