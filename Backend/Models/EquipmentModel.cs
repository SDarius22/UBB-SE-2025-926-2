namespace Backend.Models
{
    ...
    public class EquipmentModel
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EquipmentModel"/> class with specified equipment ID, name, type, specification, and stock.
        /// </summary>
        ...
        public EquipmentModel(int equipmentID, string name, string type, string specification, int stock)
        {
